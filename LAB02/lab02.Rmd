...
# Need to Keep only BMPs measured in Acres, also we are applying log scales to reduce the effect of extreme values. theme minimal is used to make plot look clean. 
bmps %>%
...
ggplot(cty_join, aes(dam_n, bmp_cost, color = factor(dam_n))) +
  ...
  theme_minimal() #Makes the plot look clean 
...
tm_shape(counties_map) +
  tm_polygons(
    ...
    lwd = 0.5 #used lwd for making boundaries thin and look clean 
  ) +
  tm_layout(
